...
def rgMF_main():
    ...
    plot_MF_gaussianaDerecha(mid, sigma, min_universo, max_universo)

# Función para graficar la MF:
def plot_MF_gaussianaDerecha(mid, sigma, min_universo, max_universo):
    ...
    plt.plot(X_values, MF_values, label=f'Right Gaussian Membership Function (mid={mid}, sigma={sigma})', color='blue')
