...
# Función para solicitar los valores de a, b, c y el rango del conjunto universo:
def tnMF_main():
    while True:
    ...
    plot_MF_triangular(a, b, c, min_universo, max_universo)

# Función para graficar la MF:
def plot_MF_triangular(a, b, c, min_universo, max_universo):
